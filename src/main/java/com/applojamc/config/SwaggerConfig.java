...
public class SwaggerConfig {
	...
	// Bean que retorna um docket vai conter configuração do Swagger
	@Bean
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.applojamc.resources"))
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfo("API Loja Online",
				...
				"Permitido uso para estudantes", "https://www.udemy.com/terms", Collections.emptyList() // Vendor Extensions
		);
	}
